...
const COLUMN_DEFS = [
  ...
  { key: "quantity", label: "Cantitate Totală" },
  { key: "unit", label: "Unitate" },
  { key: "supplier", label: "Furnizor Ultimul" },
  { key: "receipt_date", label: "Data Ultimei Intrări" },
...
const StockExportDialog: React.FC<Props> = ({ stockData, fileName }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Export Stocuri</DialogTitle>
          <DialogDescription>
