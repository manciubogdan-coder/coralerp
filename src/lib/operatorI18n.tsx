...
const ro: Dict = {
  ...
  operators: "Echipă",
  principalOperator: "Operator principal",
  totalOperators: "Număr total operatori",
  ...
  operatorName: "Operator principal",
  addOperator: "+ Adaugă operator",
  startSession: "Pornire Sesiune",
  error: "Eroare",
  errNoOperator: "Te rog completează operatorul principal și numărul total de operatori.",
  ...
  errFillOperator: "Completează operatorul principal și numărul total de operatori.",
  ...
  whichLine: "Pe ce linie se lucrează?",
  pickLine: "Alege linia",
  errNoLine: "Alege linia pe care se lucrează.",
  rebutQty: "Rebut (kg)",
  rebutHint: "Lasă 0 dacă nu a fost rebut.",
  today: "Azi",
  tomorrow: "Mâine",
  forDay: "Pentru ziua",
...
const en: Dict = {
  ...
  operators: "Team",
  principalOperator: "Main operator",
  ...
  operatorName: "Main operator",
  addOperator: "+ Add operator",
  startSession: "Start session",
  error: "Error",
  errNoOperator: "Please enter the main operator and total number of operators.",
  ...
  errFillOperator: "Enter the main operator and total number of operators.",
  ...
  whichLine: "Which line will be used?",
  pickLine: "Choose the line",
  errNoLine: "Please select the line you are working on.",
  rebutQty: "Rejects (kg)",
  rebutHint: "Leave 0 if there were no rejects.",
  today: "Today",
  tomorrow: "Tomorrow",
  forDay: "For day",
...
const ne: Dict = {
  ...
  operators: "टोली",
  principalOperator: "मुख्य अपरेटर",
  totalOperators: "अपरेटरहरूको कुल संख्या",
  startedAt: "सुरु भयो",
  ...
  operatorName: "मुख्य अपरेटर",
  addOperator: "+ अपरेटर थप्नु",
  startSession: "सेसन सुरु गर्नु",
  error: "त्रुटि",
  errNoOperator: "कृपया मुख्य अपरेटर र अपरेटरहरूको कुल संख्या लेख्नुहोस्।",
  ...
  errFillOperator: "मुख्य अपरेटर र अपरेटरहरूको कुल संख्या लेख्नुहोस्।",
  ...
  whichLine: "कुन लाइनमा काम हुनेछ?",
  pickLine: "लाइन छान्नुहोस्",
  errNoLine: "कृपया काम गर्ने लाइन छान्नुहोस्।",
  rebutQty: "बिग्रिएको (के.जी.)",
  rebutHint: "बिग्रिएको छैन भने ० राख्नुहोस्।",
  today: "आज",
  tomorrow: "भोलि",
  forDay: "दिनको लागि",
...
const hu: Dict = {
  ...
  operators: "Csapat",
  principalOperator: "Fő operátor",
  totalOperators: "Operátorok teljes száma",
  startedAt: "Indítva",
  ...
  operatorName: "Fő operátor",
  addOperator: "+ Operátor hozzáadása",
  startSession: "Munkamenet indítása",
  error: "Hiba",
  errNoOperator: "Add meg a fő operátort és az operátorok teljes számát.",
  ...
  errFillOperator: "Add meg a fő operátort és az operátorok teljes számát.",
  ...
  whichLine: "Melyik soron dolgoztok?",
  pickLine: "Válaszd ki a sort",
  errNoLine: "Válaszd ki a sort, amelyen dolgoztok.",
  rebutQty: "Selejt (kg)",
  rebutHint: "Hagyd 0-n, ha nem volt selejt.",
  today: "Ma",
  tomorrow: "Holnap",
  forDay: "Nap",
