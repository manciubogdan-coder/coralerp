...
const ro: Dict = {
  ...
  language: "Limba",
  noProduct: "Fără produs",
  today: "Azi",
  tomorrow: "Mâine",
  forDay: "Pentru ziua",
  hiddenPrevDays: "Finalizatele din zilele anterioare sunt ascunse automat",
  showDoneToday: "Arată finalizate de azi",
  hideDoneToday: "Ascunde finalizate de azi",
  groupBadge: "grup",
  doneBadge: "finalizate",
  finishGroup: "Finalizează grup",
  startGroupSession: "Pornește sesiune grup",
  totalRequested: "Total cerut",
  covered: "Acoperit",
  leftLabel: "Rămas",
  activeSessionLabel: "Sesiune activă",
  onNOrders: "(pe {n} comenzi)",
  missingLabel: "Lipsă: {n}",
  completedMark: "✓ Complet",
  noOrdersToGroup: "Nu există comenzi de grupat",
  startGroupTitle: "Pornește sesiune grup: {name}",
  startGroupDesc:
    "Se va crea o sesiune de lucru identică pentru toate comenzile din grup care nu sunt deja finalizate.",
  cancel: "Anulează",
  start: "Pornește",
  finishGroupTitle: "Finalizează sesiune grup: {name}",
  finishGroupDesc:
    "Introdu cantitatea totală produsă pentru tot grupul. Se distribuie automat pe comenzi în ordinea priorității zonelor; surplusul intră în restocări.",
  totalProducedQty: "Cantitate totală produsă",
  finish: "Finalizează",
};
...
const en: Dict = {
  ...
  tomorrow: "Tomorrow",
  forDay: "For day",
  hiddenPrevDays: "Completed orders from previous days are hidden automatically",
  showDoneToday: "Show completed today",
  hideDoneToday: "Hide completed today",
  groupBadge: "group",
  doneBadge: "completed",
  ...
  onNOrders: "(on {n} orders)",
  missingLabel: "Missing: {n}",
  completedMark: "✓ Complete",
  noOrdersToGroup: "No orders to group",
  startGroupTitle: "Start group session: {name}",
  startGroupDesc:
    "An identical work session will be created for all orders in the group that are not already completed.",
  cancel: "Cancel",
  start: "Start",
  finishGroupTitle: "Finish group session: {name}",
  finishGroupDesc:
    "Enter the total quantity produced for the whole group. It is automatically distributed across orders in zone priority order; surplus goes to restock.",
  totalProducedQty: "Total quantity produced",
  finish: "Finish",
};
...
const ne: Dict = {
  ...
  language: "भाषा",
  noProduct: "उत्पादन छैन",
  today: "आज",
  tomorrow: "भोलि",
  forDay: "दिनको लागि",
  hiddenPrevDays: "अघिल्ला दिनका समाप्त अर्डरहरू स्वतः लुकाइन्छन्",
  showDoneToday: "आजका समाप्त देखाउनु",
  hideDoneToday: "आजका समाप्त लुकाउनु",
  groupBadge: "समूह",
  doneBadge: "समाप्त",
  finishGroup: "समूह समाप्त गर्नु",
  startGroupSession: "समूह सेसन सुरु गर्नु",
  totalRequested: "कुल माग",
  covered: "पूरा भएको",
  leftLabel: "बाँकी",
  activeSessionLabel: "सक्रिय सेसन",
  onNOrders: "({n} अर्डरमा)",
  missingLabel: "चाहिने: {n}",
  completedMark: "✓ पूरा",
  noOrdersToGroup: "समूह बनाउन कुनै अर्डर छैन",
  startGroupTitle: "समूह सेसन सुरु गर्नु: {name}",
  startGroupDesc: "समूहका समाप्त नभएका सबै अर्डरहरूको लागि एउटै कार्य सेसन सिर्जना गरिनेछ।",
  cancel: "रद्द गर्नु",
  start: "सुरु गर्नु",
  finishGroupTitle: "समूह सेसन समाप्त गर्नु: {name}",
  finishGroupDesc:
    "सम्पूर्ण समूहको कुल उत्पादित परिमाण लेख्नुहोस्। यो जोन प्राथमिकता अनुसार अर्डरहरूमा स्वतः बाँडिन्छ; बढी भएको रिस्टकमा जान्छ।",
  totalProducedQty: "कुल उत्पादित परिमाण",
  finish: "समाप्त गर्नु",
};
...
const hu: Dict = {
  ...
  language: "Nyelv",
  noProduct: "Nincs termék",
  today: "Ma",
  tomorrow: "Holnap",
  forDay: "Nap",
  hiddenPrevDays: "Az előző napok kész rendelései automatikusan rejtve",
  showDoneToday: "Mai kész rendelések mutatása",
  hideDoneToday: "Mai kész rendelések elrejtése",
  groupBadge: "csoport",
  doneBadge: "kész",
  finishGroup: "Csoport befejezése",
  startGroupSession: "Csoportos munkamenet indítása",
  totalRequested: "Összes kért",
  covered: "Fedezve",
  leftLabel: "Hátralévő",
  activeSessionLabel: "Aktív munkamenet",
  onNOrders: "({n} rendelésen)",
  missingLabel: "Hiány: {n}",
  completedMark: "✓ Kész",
  noOrdersToGroup: "Nincs csoportosítható rendelés",
  startGroupTitle: "Csoportos munkamenet indítása: {name}",
  startGroupDesc:
    "A csoport összes be nem fejezett rendeléséhez azonos munkamenet jön létre.",
  cancel: "Mégse",
  start: "Indítás",
  finishGroupTitle: "Csoportos munkamenet befejezése: {name}",
  finishGroupDesc:
    "Add meg a teljes csoportra gyártott mennyiséget. Automatikusan szétosztásra kerül a rendelések között a zónák prioritása szerint; a többlet restockba kerül.",
  totalProducedQty: "Összes gyártott mennyiség",
  finish: "Befejezés",
};
